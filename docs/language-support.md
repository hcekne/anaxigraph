...
The JavaScript/TypeScript rows are the binding implementation contract beginning with AnaxiGraph
`0.4.0`. Published `0.3.0` and older snapshots may still report JavaScript-family facts as lexical.
