...
_INSTRUCTIONS = (
    ...
    "at a time and writes only checked AI descriptions to AnaxiGraph's external index. Use "
    "ANAXIGRAPH_GUIDE for build/refactor goals and ANAXIGRAPH_IMPACT before changing shared behavior. "
    "After a coherent edit, run ANAXIGRAPH_SCAN and call ANAXIGRAPH_GUIDE with reassess=true; it "
