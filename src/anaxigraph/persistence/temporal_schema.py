...
TEMPORAL_SCHEMA = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_relationship_changes_set ON snapshot_relationship_changes(relationship_set_id)",
    "CREATE INDEX IF NOT EXISTS idx_checkpoint_relationships_set ON checkpoint_relationships(relationship_set_id)",
